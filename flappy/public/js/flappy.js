...
var FlappyGame = /** @class */ (function () {
  function FlappyGame() {
    ...
    this.barrierLoader = new PipesLoader(
      this.gameHeight,
      this.gameWitdh,
      300,
      400,
    ...
    this.barrierLoader.pairs.forEach(function (pair) {
      return _this.element.appendChild(pair.element);
    });
  }
