import { EmitterOptions, mergeOptions } from './options';
import { EmptyEventType, EventListener, EventMap, EventType } from './types';
import { addCatch } from './utils';

export class EventEmitter<E extends EventType<E> = EmptyEventType> {
