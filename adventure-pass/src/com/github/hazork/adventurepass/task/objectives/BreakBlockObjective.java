...
public class BreakBlockObjective extends Objective {
  ...
  public BreakBlockObjective(Task owner, int times, String variable) {
    super(owner, times);
  ...
  public String getDescription() {
    return String.format(
      "Coloque o bloco %s %s vezes.",
      MessageUtils.getLocalizedName(material),
      times
    );
  }
  ...
  public String getStepMesage(User user) {
    return String.format(
      "§aBloco colocado! Faltam: §f%s§a/§f%s§a.",
      user.getTaskHandler().getAdvancement(owner),
      times
    );
  }
}
